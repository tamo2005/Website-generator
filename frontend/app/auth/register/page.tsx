  ...
  return (
    <div className="auth-card animate-fade-in">
      <div className="text-center mb-8">
        ...
        <p className="auth-subtitle">Start generating stunning websites with AI</p>
      </div>
      ...
      <div className="flex gap-3">
        <a href={authAPI.getGoogleOAuthURL()} className="auth-oauth-btn flex-1">
        ...
        <a href={authAPI.getGitHubOAuthURL()} className="auth-oauth-btn flex-1">
